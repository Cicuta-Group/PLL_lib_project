...
from ctypes import *
from PLL_Lib.library import Library
from PLL_Lib.constants import make_enum

import os, sys
dir = os.path.dirname(sys.modules["PLL_Lib"].__file__)
path = os.path.join(dir, "ps2000.dll")

class Ps2000lib(Library):
    def __init__(self):
        super(Ps2000lib, self).__init__("ps2000",path)
